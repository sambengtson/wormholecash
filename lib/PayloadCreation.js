...
var PayloadCreation = function () {
  ...
  _createClass(PayloadCreation, [{
    ...
    key: "freeze",
    value: async function freeze(toAddress, propertyId, amount) {
      var path = this.restURL + "payloadCreation/freeze/" + toAddress + "/" + propertyId + "/" + amount;
      try {
        var response = await _axios2.default.post(path);
        return response.data;
      } catch (error) {
    ...
    key: "unfreeze",
    value: async function unfreeze(toAddress, propertyId, amount) {
      var path = this.restURL + "payloadCreation/unfreeze/" + toAddress + "/" + propertyId + "/" + amount;
      try {
        var response = await _axios2.default.post(path);
        return response.data;
      } catch (error) {
