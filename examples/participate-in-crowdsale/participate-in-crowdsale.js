...
async function participateInCrowdSale() {
  try {
    ...
    let change = Wormhole.HDNode.derivePath(account, "0/4");
    let change2 = Wormhole.HDNode.derivePath(account, "0/0");
    ...
    let participateCrowdSale = await Wormhole.PayloadCreation.participateCrowdSale("1.0");
